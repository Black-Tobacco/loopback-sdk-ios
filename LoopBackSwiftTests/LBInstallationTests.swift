...
class LBInstallationTests : XCTestCase {
    ...
    // It's not possible in swift to override the default test order like in Objective C
    // tests are executed in alphabetical order
    // be careful if you change the function names as the variable lastId needs to be set for
    // some tests
    func test01_SingletonRepository() {
